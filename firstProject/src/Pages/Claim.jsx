      ...
      <nav className="relative z-10 bg-blue-600 text-white p-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-6">
            ...
            <button className="hover:text-blue-200 transition-colors duration-200">Services</button>
            <button className="hover:text-blue-200 transition-colors duration-200">Contact</button>
          </div>
        </div>
      </nav>
