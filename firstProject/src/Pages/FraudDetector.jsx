...
import { FaShieldAlt, FaCarCrash, FaFileAlt, FaPhoneAlt } from "react-icons/fa";
...
const FraudDetector = () => {
  ...
  const handleRedirect = () => {
    window.location.href = "https://frauddetectionashu.streamlit.app/";
  };

  const navLinks = [
    { title: "Home", icon: <FaShieldAlt /> },
    { title: "Incidents", icon: <FaCarCrash /> },
